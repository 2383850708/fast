<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:88:"G:\phpStudy\WWW\action\shop2018\public/../application/admin\view\shop\category\edit.html";i:1547114987;s:74:"G:\phpStudy\WWW\action\shop2018\application\admin\view\layout\default.html";i:1544409141;s:71:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\meta.html";i:1544409141;s:73:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\script.html";i:1544409141;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[pid]">
                ...
                <option data-type="" value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $row['pid']): ?>selected="selected"<?php endif; ?>><?php echo $vo['title']; ?></option>
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Stateswitch'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
        <?php echo build_radios('row[stateswitch]', [1=>__('Normal'), 0=>__('Hidden')], $row['stateswitch']); ?>
        </div>
    </div>
