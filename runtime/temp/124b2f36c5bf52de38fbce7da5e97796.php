<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"G:\phpStudy\WWW\action\shop2018\public/../application/admin\view\blog\banner\edit.html";i:1555314382;s:74:"G:\phpStudy\WWW\action\shop2018\application\admin\view\layout\default.html";i:1544409141;s:71:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\meta.html";i:1544409141;s:73:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\script.html";i:1544409141;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-contents" class="form-control " rows="5" name="row[contents]" cols="50"><?php echo $row['contents']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-url" class="form-control" name="row[url]" type="text" value="<?php echo $row['url']; ?>">
        </div>
    </div>
