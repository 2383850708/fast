<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"G:\phpStudy\WWW\action\shop2018\public/../application/admin\view\blog\article\edit.html";i:1554357574;s:74:"G:\phpStudy\WWW\action\shop2018\application\admin\view\layout\default.html";i:1544409141;s:71:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\meta.html";i:1544409141;s:73:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\script.html";i:1544409141;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
	...
	<div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-pid" data-rule="required" class="form-control selectpicker" name="row[category_id]">
                ...
                <option data-type="" value="<?php echo $vo['id']; ?>" <?php if($row['category_id'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['name']; ?></option>
	...
	<div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_select('row[flag][]', ['index'=>'首页','hot'=>'热门','recommend'=>'推荐'], $row['flag'], ['id'=>'c-flag','class'=>'form-control selectpicker','multiple'=>'multiple','required'=>'','tabindex'=>'-98'] ); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-summary" class="form-control " rows="5" name="row[summary]"  cols="50"><?php echo $row['summary']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-keyword" placeholder="多个关键字以逗号分隔" class="form-control" name="row[keyword]" value="<?php echo $row['keyword']; ?>" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Hits'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-hits" class="form-control" name="row[hits]" value="<?php echo $row['hits']; ?>" type="number">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-image" class="form-control" size="50" name="row[thumbimage]" type="text" value="<?php echo $row['thumbimage']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-pageviews" value="<?php echo $row['pageviews']; ?>" class="form-control" name="row[pageviews]" type="number">
        </div>
    </div>
	...
	<div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-weigh" value="<?php echo $row['weigh']; ?>" class="form-control" name="row[weigh]" type="number">
        </div>
    </div>
	...
	<input type="hidden" name="old_keyword" value="<?php echo $row['keyword']; ?>" />
