<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:91:"G:\phpStudy\WWW\action\shop2018\public/../application/admin\view\general\profile\index.html";i:1544409141;s:74:"G:\phpStudy\WWW\action\shop2018\application\admin\view\layout\default.html";i:1544409141;s:71:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\meta.html";i:1544409141;s:73:"G:\phpStudy\WWW\action\shop2018\application\admin\view\common\script.html";i:1544409141;}*/ ?>
<!DOCTYPE html>
                ...
                <form id="update-form" role="form" data-toggle="validator" method="POST" action="<?php echo url('general.profile/update'); ?>">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="password" placeholder="<?php echo __('Leave password blank if dont want to change'); ?>" autocomplete="new-password" name="row[password]" value=""/>
                        </div>
                        <div class="form-group">
